...
const TextScroll: React.FC<Props> = () => {
    ...
    if (refContainer.current) {
        ...
        sectionProgress = Math.min(noOfParagraphs - 0.5, Math.max(0.5, percentY * noOfParagraphs));
    }

    return (
        <div className="bg-black text-white mt-64">
            <div
                ref={refContainer}
            ...
            >
                <div className="leading-[1.15]">
                    ...
                    >
                       {scrollY} Lorem ipsum dolor sit amet.amet consectetur adipisicing elit. Deleniti, temporibus?
                    </span>
                    <span
